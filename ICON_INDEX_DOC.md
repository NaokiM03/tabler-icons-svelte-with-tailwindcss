...
| SquareRoundedNumberZero    | square-rounded-number-0       |
| SquareRoundedNumberOne     | square-rounded-number-1       |
| SquareRoundedNumberTwo     | square-rounded-number-2       |
| SquareRoundedNumberThree   | square-rounded-number-3       |
| SquareRoundedNumberFour    | square-rounded-number-4       |
| SquareRoundedNumberFive    | square-rounded-number-5       |
| SquareRoundedNumberSix     | square-rounded-number-6       |
| SquareRoundedNumberSeven   | square-rounded-number-7       |
| SquareRoundedNumberEight   | square-rounded-number-8       |
| SquareRoundedNumberNine    | square-rounded-number-9       |
